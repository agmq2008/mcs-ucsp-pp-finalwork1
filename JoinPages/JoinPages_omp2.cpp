/*
 ============================================================================
 Name        : JoinPages_omp2.cpp
 Description : Join Pages using OMP and divide the english file one block per thread
 ============================================================================
 */
...
void join_problem(char *koFileName, char *enFileName, char *outFileName)
{
	...
	// Counting lines in english file
